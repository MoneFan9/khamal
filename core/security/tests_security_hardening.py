...
class SecurityHardeningTests(TestCase):
    ...
    def test_mount_fails_if_not_block_device(self, mock_guard_run, mock_block, mock_installed, mock_active):
    ...
    @patch("security.usb_mount.USBGuardManager.is_installed")
    @patch("security.usb_guard.subprocess.run")
    def test_mount_fails_if_service_inactive(self, mock_guard_run, mock_installed, mock_active):
        mock_installed.return_value = True
    ...
    @patch("security.usb_mount.USBGuardManager.is_installed")
    @patch("security.usb_guard.subprocess.run")
    def test_mount_fails_if_device_not_authorized(self, mock_guard_run, mock_installed, mock_active, mock_list):
        mock_installed.return_value = True
        mock_active.return_value = True
    ...
    @patch("security.usb_mount.USBGuardManager.is_installed")
    @patch("security.usb_guard.subprocess.run")
    def test_mount_fails_if_no_allow_rules(self, mock_guard_run, mock_installed, mock_active, mock_list):
        mock_installed.return_value = True
        mock_active.return_value = True
    ...
    @patch("security.usb_guard.subprocess.run")
    def test_mount_options_applied(self, mock_guard_run, mock_makedirs, mock_run, mock_installed, mock_active, mock_list):
        mock_installed.return_value = True
        mock_active.return_value = True
