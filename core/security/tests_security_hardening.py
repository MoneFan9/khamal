...
class SecurityHardeningTests(TestCase):
    ...
    def test_mount_fails_if_not_block_device(self, mock_installed, mock_active, mock_block, mock_list):
        ...
        # Mocking subprocess.run for is_installed and is_service_active calls within mount_volume
        # to avoid FileNotFoundError in environments without usbguard/systemctl
