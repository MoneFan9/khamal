...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-&r65l-fc0#grl%0^nv^v90*=aarx&547-ty_m4vez@4vzv4svm")
...
MIDDLEWARE = [
    ...
    "accounts.middleware.RestrictedAdminMiddleware",
]
...
if (BASE_DIR.parent / "pro").exists():
    ...
    # Add White Label context processor dynamically
    TEMPLATES[0]["OPTIONS"]["context_processors"].insert(
        3, "pro.white_label.context_processors.white_label"
    )
...
DOCKER_URL = env("DOCKER_URL", default="tcp://127.0.0.1:2375")
