...
from core.projects.nixpacks import build_image, plan_build, NixpacksError, parse_nixpacks_plan, NixpacksPlan
...
class TestNixpacksService:
    ...
    @patch('asyncio.create_subprocess_exec')
    async def test_build_image_unexpected_exception(self, mock_exec):
        # Mock generic exception
        mock_exec.side_effect = Exception("OS error")
