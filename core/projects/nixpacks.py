...
class NixpacksPlan:
    """
    NixpacksPlan: Analyzes a build plan generated by Nixpacks.

    Nixpacks is Khamal's default build engine. It automatically detects the
    language and framework of the source code. This class extends that
    intelligence by identifying required infrastructure (like databases)
    from the build plan to enable Zero-Config provisioning.
    """
...
async def build_image(
    ...
    Nixpacks creates OCI-compliant images without requiring a Dockerfile.
    Khamal uses this to provide a Heroku-like experience: "Just push code,
