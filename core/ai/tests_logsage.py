...
class TestLogSagePreprocessor(unittest.TestCase):
    ...
    def test_severity_scoring(self):
        ...
        self.assertEqual(self.preprocessor.get_severity_score("EXCEPTION: unhandled exception"), 95)
        self.assertEqual(self.preprocessor.get_severity_score("TRACEBACK: most recent call last"), 95)
        self.assertEqual(self.preprocessor.get_severity_score("ERROR: unexpected error"), 85)
        self.assertEqual(self.preprocessor.get_severity_score("OUTOFMEMORY: process killed"), 100)
        self.assertEqual(self.preprocessor.get_severity_score("TIMEOUT: request timed out"), 70)
